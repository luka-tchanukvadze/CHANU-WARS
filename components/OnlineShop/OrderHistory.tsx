    ...
    items: [
      {
        ...
        price: 100000,
        sku: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdTLrXk7owVSuLDHlRGkNRX-yhxxX4wX0tXQ&s",
      },
      {
        name: "Lightsaber",
        type: "Weapon",
      ...
      },
      {
        ...
        type: "Apparel",
        description: "Imperial-grade armor for the loyal soldier",
        price: 75000,
        sku: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdTLrXk7owVSuLDHlRGkNRX-yhxxX4wX0tXQ&s",
      },
    ],
    ...
    items: [
      {
        ...
        type: "Ship",
        description: "Versatile Rebel Alliance strike fighter",
        price: 75000,
        sku: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdTLrXk7owVSuLDHlRGkNRX-yhxxX4wX0tXQ&s",
      },
    ],
            ...
            >
              ...
              >
                <motion.div>
                  ...
                  <motion.p variants={itemVariants} className="text-blue-300">
                    {order.date}
                  </motion.p>
                </motion.div>
                <motion.div variants={itemVariants} className="text-right">
                  ...
                  <motion.p variants={itemVariants} className="text-cyan-400">
                    {order.status}
                  </motion.p>
                </motion.div>
                <motion.div
