...
const ShipAndLasersTwo = ({ ShipImg, damage, health, children }: PropsType) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-[-2rem] left-0 right-0 h-2 bg-cyan-200 w-full" />

        {/* Health Bar Foreground */}
        <div
          className={`absolute bottom-[-2rem] left-0 right-0 h-2 bg-red-600`}
...
export default ShipAndLasersTwo;
