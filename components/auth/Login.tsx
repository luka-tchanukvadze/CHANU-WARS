      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <motion.div
              className={`inline-block px-4 py-2 bg-black/50 rounded-lg border border-${currentTheme.secondary}-500/50 mb-4`}
              animate={{
                boxShadow: [
                  `0 0 20px rgba(${
            ...
            <motion.h1
              className="text-3xl font-bold text-white mb-2 tracking-wider font-mono"
              animate={{
                textShadow: [
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="text-center">
                  ...
                  <div className="font-bold tracking-wide text-sm">JEDI</div>
                </div>
              </motion.button>
              <motion.button
                type="button"
              ...
              >
                <div className="text-center">
                  ...
                  <div className="font-bold tracking-wide text-sm">SITH</div>
                </div>
              </motion.button>
            </div>
          </motion.div>
          ...
          >
            <motion.a
              href="#"
              className={`block text-gray-400 hover:${
                formData.faction === "jedi"
                  ? "text-cyan-300"
                  : "text-orange-300"
          ...
          <div className="absolute bottom-4 left-4 text-xs font-mono text-gray-500">
            <motion.span
              ...
              transition={{ duration: 3, repeat: Number.POSITIVE_INFINITY }}
            >
              {formData.faction === "jedi" ? "TEMPLE_v1.2.3" : "EMPIRE_v2.4.7"}
            </motion.span>
          </div>
        </motion.div>
      </motion.div>
